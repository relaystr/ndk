...
Packages with other changes:
 ...
 - [`ndk` - `v0.8.0-dev.0+1`](#ndk---v080-dev01)
 - [`ndk_objectbox` - `v0.2.9-dev.0`](#ndk_objectbox---v029-dev0)
 - [`nip07_event_signer` - `v1.0.8-dev.0`](#nip07_event_signer---v108-dev0)
 - [`ndk_drift` - `v0.1.0-dev.0+1`](#ndk_drift---v010-dev01)
 - [`ndk_flutter` - `v0.8.0-dev.0+2`](#ndk_flutter---v080-dev02)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `nip07_event_signer` - `v1.0.8-dev.0`
 - `ndk_drift` - `v0.1.0-dev.0+1`
 - `ndk_flutter` - `v0.8.0-dev.0+2`
