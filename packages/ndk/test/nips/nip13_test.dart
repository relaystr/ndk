...
void main() {
  ...
  group('NIP-13 Proof of Work', () {
    group('countLeadingZeroBits', () {
      ...
      test('should handle NIP-13 specification examples', () {
        ...
        expect(
          Nip13.countLeadingZeroBits('002f'),
          equals(10),
      ...
      test('should handle edge cases', () {
        ...
        // All zeros
        expect(
          Nip13.countLeadingZeroBits('0000'),
          equals(16),
          reason: '16 zero bits should return 16',
        );
        expect(
          Nip13.countLeadingZeroBits('00000'),
          equals(20),
    ...
    test('mineEvent should meet difficulty', () async {
      ...
      expect(
        pow.checkPoWDifficulty(event: minedEvent, targetDifficulty: 2),
        isTrue,
      );
    });
    ...
    test('should return null when no nonce tag present', () {
      ...
      final targetDifficulty = Nip13.getTargetDifficultyFromEvent(
        eventWithoutNonce,
      );
      expect(
        targetDifficulty,
  ...
  test('validate event: greater POW', () {
    ...
    final invalidEvent = minedEvent.copyWith(
      tags: [
        ['nonce', '123', '14'],
      ],
    );
