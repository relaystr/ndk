...
void main() {
  group('cleanRelayUrl RFC 3986 normalization', () {
    ...
    test('preserves non-default ports', () {
      expect(
        cleanRelayUrl('wss://relay.damus.io:8080'),
        'wss://relay.damus.io:8080',
      );
      expect(cleanRelayUrl('ws://localhost:8080'), 'ws://localhost:8080');
      expect(
        cleanRelayUrl('wss://relay.damus.io:80'),
        'wss://relay.damus.io:80',
      );
    ...
    test('preserves query string', () {
      expect(
        cleanRelayUrl('wss://relay.damus.io/path?query=value'),
    ...
    test('preserves fragment', () {
      expect(
        cleanRelayUrl('wss://relay.damus.io/path#section'),
    ...
    test('preserves query and fragment together', () {
      expect(
        cleanRelayUrl('wss://relay.damus.io/path?query=value#section'),
    ...
    test('normalizes percent-encoding in query string (RFC 3986)', () {
      ...
      expect(
        cleanRelayUrl('wss://relay.damus.io/path?key%41=value'),
        'wss://relay.damus.io/path?keyA=value',
      );
      // %2f = '/' (reserved) should stay encoded but uppercase
      expect(
        cleanRelayUrl('wss://relay.damus.io/path?key=%2fvalue'),
    ...
    test('normalizes percent-encoding in fragment (RFC 3986)', () {
      ...
      expect(
        cleanRelayUrl('wss://relay.damus.io/path#section%7E'),
        'wss://relay.damus.io/path#section~',
      );
      // %23 = '#' (reserved) should stay encoded but uppercase
      expect(
        cleanRelayUrl('wss://relay.damus.io/path#section%2f'),
    ...
    test('removes dot segments from path (RFC 3986 Section 5.2.4)', () {
      expect(
        cleanRelayUrl('wss://relay.damus.io/a/./b'),
      ...
      expect(
        cleanRelayUrl('wss://relay.damus.io/a/b/c/../d'),
        'wss://relay.damus.io/a/b/d',
      );
      expect(
        cleanRelayUrl('wss://relay.damus.io/a/b/../../../c'),
    ...
    test(
      ...
      () {
        ...
        expect(
          cleanRelayUrl('wss://relay.damus.io/path%2fto'),
          'wss://relay.damus.io/path%2Fto',
        );
        expect(
          cleanRelayUrl('wss://relay.damus.io/path%2a'),
    ...
    test('keeps reserved characters percent-encoded (RFC 3986)', () {
      ...
      expect(
        cleanRelayUrl('wss://relay.damus.io/path%2F'),
        'wss://relay.damus.io/path%2F',
      );
      expect(
        cleanRelayUrl('wss://relay.damus.io/path%3F'),
