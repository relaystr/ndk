...
void main() {
  group('NwcMethod', () {
    test('should return the correct NwcMethod for known plaintext', () {
      ...
      expect(
        NwcMethod.fromPlaintext('get_balance'),
      ...
      expect(
        NwcMethod.fromPlaintext('multi_pay_invoice'),
        equals(NwcMethod.MULTI_PAY_INVOICE),
      );
      expect(
        NwcMethod.fromPlaintext('pay_keysend'),
        equals(NwcMethod.PAY_KEYSEND),
      );
      expect(
        NwcMethod.fromPlaintext('multi_pay_keysend'),
        equals(NwcMethod.MULTI_PAY_KEYSEND),
      );
      expect(
        NwcMethod.fromPlaintext('make_invoice'),
        equals(NwcMethod.MAKE_INVOICE),
      );
      expect(
        NwcMethod.fromPlaintext('lookup_invoice'),
        equals(NwcMethod.LOOKUP_INVOICE),
      );
      expect(
        NwcMethod.fromPlaintext('list_transactions'),
    ...
    test('should return UNKNOWN for unknown plaintext', () {
      expect(
        NwcMethod.fromPlaintext('unknown_method'),
        equals(NwcMethod.UNKNOWN),
      );
    });
  });
}
