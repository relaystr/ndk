...
void main() {
  ...
  group('Timeout - query', () {
    ...
    test(
      'timeout triggers default ndk values within expected time window',
      () async {
        ...
        expect(
          elapsedMilliseconds,
          greaterThanOrEqualTo(myTimeout.inMilliseconds - 1000),
        ); // lower bound
        expect(
          elapsedMilliseconds,
          lessThanOrEqualTo(myTimeout.inMilliseconds + 1000),
        ); // upper bound
      },
    );
  });
