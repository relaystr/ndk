...
class WebSocket {
  /// {@macro web_socket}
  ///
  /// [compressionEnabled] controls native per-message compression negotiation.
  /// Defaults to true. Browser WebSocket APIs cannot control compression;
  /// this option has no effect on web.
  WebSocket(
    Uri uri, {
