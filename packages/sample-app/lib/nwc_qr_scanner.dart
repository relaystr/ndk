...
class _WalletQrScannerDialogState extends State<_WalletQrScannerDialog> {
  ...
  Future<void> _chooseWallet() async {
    ...
    final result = await showDialog<WalletInputScanResult>(
      context: context,
      builder: (_) => _WalletChooserDialog(
...
class _ManualWalletInputDialogState extends State<_ManualWalletInputDialog> {
  ...
  String _kindLabel(
    ndk_l10n.AppLocalizations l10n,
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        FilledButton(
          onPressed: _isValid
              ? () => Navigator.of(context).pop(
                    _ManualWalletInputResult.value(_controller.text.trim()),
                  )
              : null,
              ...
              child: FutureBuilder<List<CashuMintSuggestion>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (suggestions.isEmpty) {
                    return Center(child: Text(l10n.noCashuMintSuggestions));
                  }
